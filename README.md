...
### Option A: Replit (Recommended for Quick Deploy)

DataFlow is pre-configured for Replit deployment:

1. The `DATABASE_URL` environment variable is automatically set by Replit's PostgreSQL
2. Build and deploy:
