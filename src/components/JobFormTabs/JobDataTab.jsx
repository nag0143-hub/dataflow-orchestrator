...
import { ChevronDown, ChevronUp, Database, Filter, RefreshCw, FolderOutput, Settings2, Trash2, FileText, FolderSearch, Asterisk, Plus, X } from "lucide-react";
...
function FlatFileSourcePanel({ formData, setFormData }) {
  ...
  if (isFileSource) {
    return (
      <div className="space-y-5">
        <FlatFileSourcePanel formData={formData} setFormData={setFormData} />
